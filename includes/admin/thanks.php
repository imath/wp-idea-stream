...
function wp_idea_stream_admin_credits() {
	...
	<div class="wrap about-wrap">
		...
		<div class="changelog">
			...
			<p><?php printf( esc_html__( 'WP Idea Stream was the choice of the WordCamp Paris 2015 organization team to manage their &quot;Call for Speakers&quot;. Some requested features were very specifics to their need and were all added as custom hooks in the %s file.', 'wp-idea-stream' ), '<a href="https://github.com/imath/wc-talk">wp-idea-stream-custom.php</a>' ); ?></p>
			<p><?php esc_html_e( 'The plugin was completely transform to let the speakers submit their talks privately. The managing team was able to discuss together using private comments and to evaluate each talk using the built-in rating system.', 'wp-idea-stream' ); ?></p>
			<p><?php printf( esc_html__( 'Some other features such as a sign-up page and the ability to export all submitted talks as a csv file have been added to the current version (%s). Many thanks to WordCamp Paris organizers and speakers for this great experience.', 'wp-idea-stream' ), $display_version ); ?></p>
		</div>
