...
class WP_Idea_Stream_Admin {
	...
	private function setup_globals() {
		...
		// Preferences
		$this->comments_disjoined = wp_idea_stream_is_comments_disjoined();
		$this->sticky_enabled     = wp_idea_stream_is_sticky_enabled();
	}
	...
	private function includes() {
		$autoload = wp_idea_stream()->autoload;
